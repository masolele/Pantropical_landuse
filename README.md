...
- **Africa**: {[Model](https://huggingface.co/datasets/Masolele/deforestwatch-models/blob/main/best_weights_att_unet_lagtime_5_Fused3_2023_totalLoss6V1_without_loss_sent_Southeast_Asia23.onnx)}
